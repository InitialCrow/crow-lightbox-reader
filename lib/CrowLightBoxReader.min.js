...
e.prepend(this.nodes.main),e.classList.remove("crow-hide")}}},{key:"restoreBody",value:function(){if(!1!==this.nodeToHide&&this.poolHideNode.length>0){var e=document.getElementById(this.nodeToHide)
