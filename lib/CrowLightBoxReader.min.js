...
n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}return function(t,r,n){return r&&e(t.prototype,r),n&&e(t,n),t}}(),_react=require("react"),_react2=_interopRequireDefault(_react)
...
return this.poolItems.map(function(r,n){void 0!==e.renderVideoItemThumb(r,n)&&t.push(e.renderVideoItemThumb(r,n)),void 0!==e.renderImageItemThumb(r,n)&&t.push(e.renderImageItemThumb(r,n)),void 0!==e.renderAudioItemThumb(r,n)&&t.push(e.renderAudioItemThumb(r,n))}),t}return void this.console("Bug on CrowLightBoxReader => renderPoolItemsThumb func || you need to pass not empty items into items props on lightbox")}},{key:"renderPoolListThumb",value:function(){if(!1!==this.showPool)return _react2.default.createElement("ul",{key:"r1",className:"crow-lightbox-reader-pool-list"},this.renderPoolItemsThumb())}},{key:"showRenderer",value:function(){if(!1!==this.showLightBox){var e=[]
